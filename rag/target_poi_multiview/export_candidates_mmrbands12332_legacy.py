...
def main():
    ...
    default_tag = "dst_time_mmrbands12_3_3_2_noleak_trainrand_scored"
    ...
    parser.add_argument("--high_k", type=int, default=12)
    parser.add_argument("--mid_k", type=int, default=3)
    parser.add_argument("--far_k", type=int, default=3)
