...
TRAJECTORY_DIM="${TRAJECTORY_DIM:-0}"
TRAJ_ENCODER_TAG="${TRAJ_ENCODER_TAG:-auto}"
...
if [[ "${TRAJ_ENCODER_TAG}" == "auto" ]]; then
  case "${BACKBONE_KEY}" in
    qwen25_*) TRAJ_ENCODER_TAG="qwen25_3b" ;;
    llama32_*) TRAJ_ENCODER_TAG="llama32_3b" ;;
    *) TRAJ_ENCODER_TAG="default" ;;
  esac
fi

case "${TRAJ_ENCODER_TAG}" in
  default|qwen25_3b)
    DEFAULT_TRAIN_TRAJ_EMB="./datasets/${DATASET_DIR}/preprocessed/trajectory_embeddings_gsm8k.pt"
    DEFAULT_TEST_TRAJ_EMB="./datasets/${DATASET_DIR}/preprocessed/test_embeddings_gsm8k.pt"
    ;;
  *)
    DEFAULT_TRAIN_TRAJ_EMB="./datasets/${DATASET_DIR}/preprocessed/trajectory_embeddings_gsm8k_${TRAJ_ENCODER_TAG}.pt"
    DEFAULT_TEST_TRAJ_EMB="./datasets/${DATASET_DIR}/preprocessed/test_embeddings_gsm8k_${TRAJ_ENCODER_TAG}.pt"
    ;;
esac

TRAIN_TRAJ_EMB="${TRAIN_TRAJ_EMB:-${DEFAULT_TRAIN_TRAJ_EMB}}"
TEST_TRAJ_EMB="${TEST_TRAJ_EMB:-${DEFAULT_TEST_TRAJ_EMB}}"
...
log "Trajectory encoder tag: ${TRAJ_ENCODER_TAG}"
