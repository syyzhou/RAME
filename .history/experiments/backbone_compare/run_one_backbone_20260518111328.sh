...
case "${DATASET_KEY}" in
  nyc)
    DATASET_NAME="nyc"
    DATASET_DIR="NYC"
    DEFAULT_TRAIN_FILE="./datasets/NYC/preprocessed/train_qa_pairs_llm4poi_gsm8k_candidates_gsm8k_final_mix10trans4geo3hist3_rerank_ret075_trans075_hist1_geo0.json"
    DEFAULT_TEST_FILE="./datasets/NYC/preprocessed/test_qa_pairs_llm4poi_gsm8k_candidates_gsm8k_final_mix10trans4geo3hist3_rerank_ret075_trans075_hist1_geo0.txt"
  ...
  ca)
    ...
    DEFAULT_TRAIN_RET_QUERY="./datasets/CA/preprocessed/gsm8k_final_valartifact_fused_train_queries.pt"
    DEFAULT_TEST_RET_QUERY="./datasets/CA/preprocessed/gsm8k_final_valartifact_fused_test_queries.pt"
    ;;
  tky)
    DATASET_NAME="tky"
    DATASET_DIR="TKY"
    ...
    DEFAULT_TRAIN_RET_QUERY="./datasets/TKY/preprocessed/gsm8k_final_valartifact_fused_train_queries.pt"
    DEFAULT_TEST_RET_QUERY="./datasets/TKY/preprocessed/gsm8k_final_valartifact_fused_test_queries.pt"
    ;;
  *)
