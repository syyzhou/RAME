...
case "${DATASET_KEY}" in
  nyc)
    ...
    DEFAULT_TRAIN_RET_QUERY="./datasets/NYC/preprocessed/gsm8k_final_fused_train_queries.pt"
    DEFAULT_TEST_RET_QUERY="./datasets/NYC/preprocessed/gsm8k_final_fused_test_queries.pt"
    ;;
  ca)
    DATASET_NAME="ca"
    DATASET_DIR="CA"
