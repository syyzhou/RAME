...
class UmRaConfig:
    ...
    router2_input_source: str = "trajectory"  # trajectory / hidden_mean / hidden_token
    ...
    router1_input_source: str = "retquery"  # retquery / hidden_mean / hidden_token
